...
with fl.SI_unit_system:
    ...
    params = fl.SimulationParams(
        ...
        operating_condition=fl.AerospaceCondition(
            ...
            alpha=-90
            * fl.u.deg,  # Angle of attack of -90 degrees meaning the flow comes from above
        ...
        models=[
            ...
            fl.Freestream(
                surfaces=volume_mesh[
                    "farField/farField"
                ],  # Apply freestream boundary condition on farField/farField
                name="Freestream",
            ),
            fl.Wall(
                surfaces=volume_mesh[
                    "innerRotating/blade"
                ],  # Apply no-slip wall boundary condition to innerRotating/blade surfaces
                name="NoSlipWall",
            ),
        ],
    )
